...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationsTravelInformationLegs = factory(root.CyberSource.ApiClient);
  }
})(void 0, function (ApiClient) {
  'use strict';
  /**
   * The Riskv1authenticationsTravelInformationLegs model module.
   * @module model/Riskv1authenticationsTravelInformationLegs
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationsTravelInformationLegs</code>.
  ...
  /**
   * Constructs a <code>Riskv1authenticationsTravelInformationLegs</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:model/Riskv1authenticationsTravelInformationLegs} The populated <code>Riskv1authenticationsTravelInformationLegs</code> instance.
   */
