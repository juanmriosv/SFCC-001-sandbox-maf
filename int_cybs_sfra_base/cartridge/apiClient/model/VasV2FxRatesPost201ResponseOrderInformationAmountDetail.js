...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.VasV2FxRatesPost201ResponseOrderInformationAmountDetail = factory(root.CyberSource.ApiClient);
  }
})(void 0, function (ApiClient) {
  'use strict';
  /**
   * The VasV2FxRatesPost201ResponseOrderInformationAmountDetail model module.
   * @module model/VasV2FxRatesPost201ResponseOrderInformationAmountDetail
   * @version 2.0.0
   */

  /**
   * Constructs a new <code>VasV2FxRatesPost201ResponseOrderInformationAmountDetail</code>.
   * @alias module:model/VasV2FxRatesPost201ResponseOrderInformationAmountDetail
   * @class
   */
  ...
  /**
   * Constructs a <code>VasV2FxRatesPost201ResponseOrderInformationAmountDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VasV2FxRatesPost201ResponseOrderInformationAmountDetail} obj Optional instance to populate.
   * @return {module:model/VasV2FxRatesPost201ResponseOrderInformationAmountDetail} The populated <code>VasV2FxRatesPost201ResponseOrderInformationAmountDetail</code> instance.
   */
  ...
  exports.constructFromObject = function (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('markedUpForeignAmount')) {
        obj['markedUpForeignAmount'] = ApiClient.convertToType(data['markedUpForeignAmount'], 'String');
      }
    }
  ...
  /**
   * The transaction amount denominated in the recipient's currency. Required 
   * @member {String} markedUpForeignAmount
   */

  exports.prototype['markedUpForeignAmount'] = undefined;
  return exports;
});