...
(function (root, factory) {
...
})(void 0, function (ApiClient, Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication) {
  'use strict';
  /**
  ...
  exports.constructFromObject = function (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('strongAuthentication')) {
        obj['strongAuthentication'] = Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication.constructFromObject(data['strongAuthentication']);
      }
  ...
  /**
   * @member {module:model/Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication} strongAuthentication
   */
